...
void test_validate_my_username()
{
     ...
     */
    const char* expectedName = my_username();
    const char* actualName = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(expectedName, actualName, "ERR: two strings are not equal");
}
